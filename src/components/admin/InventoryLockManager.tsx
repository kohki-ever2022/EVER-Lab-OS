...
const InventoryLockManager: React.FC = () => {
  ...
  const sortedSnapshots = [...inventorySnapshots].sort(
    (a, b) =>
      ...
      {canLock && (
        <div className='bg-white p-6 rounded-lg shadow-md mb-8'>
          <h3 className='text-lg font-bold mb-4'>
            {t('executeInventoryLock')}
          </h3>
          <p className='text-sm text-gray-600 mb-4'>{t('lockDescription')}</p>
            ...
            <tbody className='bg-white divide-y divide-gray-200'>
              {sortedSnapshots.map((snapshot: InventorySnapshot) => (
                <tr key={snapshot.id}>
                  ...
                  <td className='px-6 py-4 whitespace-nowrap'>
                    {snapshot.consumables.length}
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap'>
                    {getUserName(snapshot.createdBy)}
                  </td>
                </tr>
              ))}
