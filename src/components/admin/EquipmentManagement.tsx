...
const EquipmentManagement: React.FC = () => {
  ...
  const [currentItem, setCurrentItem] = useState<Partial<Equipment> | null>(
    null
  );
          ...
          <tbody className='bg-white divide-y divide-gray-200'>
            {equipment.map((item) => (
              <tr key={item.id}>
                ...
                <td className='px-6 py-4 whitespace-nowrap'>
                  {item.rate} {isJapanese ? item.rateUnitJP : item.rateUnitEN}
                </td>
        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4'>
          <div className='bg-white rounded-lg shadow-xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto'>
            <h3 className='text-2xl font-bold mb-6'>
              {currentItem.id ? t('editEquipment') : t('addNewEquipment')}
            </h3>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div className='col-span-2 flex items-center'>
                  <input
                    ...
                    id='isReservable'
                    name='isReservable'
                    checked={currentItem.isReservable || false}
                    onChange={handleChange}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <input
                      type='number'
                      name='pmIntervalDays'
                      value={currentItem.pmIntervalDays || ''}
                      onChange={handleChange}
                      className='mt-1 block w-full border-gray-300 rounded-md shadow-sm'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={currentItem.calibrationIntervalDays || ''}
                      onChange={handleChange}
                      className='mt-1 block w-full border-gray-300 rounded-md shadow-sm'
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={currentItem.lastCalibrationDate || ''}
                      onChange={handleChange}
                      className='mt-1 block w-full border-gray-300 rounded-md shadow-sm'
                    />
                  </div>
