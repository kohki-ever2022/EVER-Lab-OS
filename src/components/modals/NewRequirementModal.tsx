          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg modal-content">
            ...
            <form onSubmit={handleAddRequirement} className="space-y-4">
              ...
              <div>
               ...
               <div>
                <label className="block text-sm font-medium">{t('regulation')}</label>
                <select value={newRequirement.type} onChange={e => setNewRequirement(p => ({...p, type: e.target.value as RegulationType}))} className="w-full border rounded p-2 mt-1">
              ...
              <div className="flex justify-end gap-2 mt-4">
                <button type="button" onClick={onClose} className="px-4 py-2 border rounded hover:bg-gray-50">{t('cancel')}</button>
