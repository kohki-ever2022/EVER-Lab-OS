...
export const CheckSquareIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...iconProps} {...props} viewBox='0 0 24 24'>
...
export const ArchiveIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...iconProps} {...props} viewBox='0 0 24 24'>
...
export const QrCodeIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='currentColor'
    viewBox='0 0 24 24'
...
export const LabIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const PdfIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    ...
    {...props}
  >
    <path d='M19,20H5V4H13.29L19,9.71V20M13,9V4H5A2,2 0 0,0 3,6V20A2,2 0 0,0 5,22H19A2,2 0 0,0 21,20V9H13M10.5,18H13.5V17H10.5V18M10.5,15H15.5V14H10.5V15M8.5,12H15.5V11H8.5V12Z' />
  </svg>
);
...
export const getManualIcon = (type: ManualType) => {
  switch (type) {
    case ManualType.YouTube:
      return <YoutubeIcon />;
    case ManualType.PDF:
      return <PdfIcon />;
    case ManualType.ExternalLink:
      return <LinkIcon />;
  }
};

// Icon from FavoriteConsumablesList.tsx
export const HeartIconFill: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
...
export const CaretDownIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    className={`w-5 h-5 transition-transform ${props.className}`}
    fill='currentColor'
    viewBox='0 0 20 20'
    {...props}
  >
...
export const PriorityUrgentIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const PriorityHighIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const PriorityMediumIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const PriorityLowIcon: React.FC<{ className?: string }> = (props) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
