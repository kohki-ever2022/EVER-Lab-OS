    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">An unexpected error occurred. Please reload the page.</p>
                {isDevelopment && (
                    <details className="mb-4">
                        <summary className="cursor-pointer text-blue-600 hover:text-blue-800">Error Details (Dev Mode)</summary>
