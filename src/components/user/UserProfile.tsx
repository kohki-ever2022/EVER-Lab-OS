...
const UserProfile: React.FC = () => {
  ...
  const infoFields = [
    ...
    {
      labelKey: 'company',
      value: company ? (isJapanese ? company.nameJP : company.nameEN) : '',
    },
  ...
  return (
    <div>
      <div className='flex justify-between items-center mb-6'>
        <h2 className='text-3xl font-bold text-ever-black'>{t('profile')}</h2>
        {!isEditing && (
          <button
        ...
        <div className='flex items-center mb-6'>
          ...
          <div className='ml-6'>
            {isEditing ? (
              ...
              <h3 className='text-3xl font-bold text-ever-black'>
                {currentUser.name}
              </h3>
            )}
