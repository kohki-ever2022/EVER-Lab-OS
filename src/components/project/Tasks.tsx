...
const PriorityIcon: React.FC<{ priority: TaskPriority }> = ({ priority }) => {
  const iconMap = {
    [TaskPriority.Urgent]: (
      <PriorityUrgentIcon className='w-4 h-4 text-red-500' />
    ),
    [TaskPriority.High]: (
      <PriorityHighIcon className='w-4 h-4 text-orange-500' />
    ),
    [TaskPriority.Medium]: (
      <PriorityMediumIcon className='w-4 h-4 text-yellow-500' />
    ),
