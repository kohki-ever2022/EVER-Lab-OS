...
function createGenericCrud<T extends { id: string }>(
  ...
  const notify = (data: T[]) =>
    (
      adapter as unknown as {
        notifySubscribers: (collectionName: string, data: unknown[]) => void;
      }
  ...
  return {
    ...
    async getById(id: string): Promise<Result<T | null>> {
      return {
        success: true,
        data: collection.find((i) => i.id === id) || null,
      };
    },
    ...
    async update(item: T): Promise<Result<T>> {
      ...
      if (index === -1)
        return {
          success: false,
          error: new Error(`${collectionName} not found`),
        };
    ...
    subscribe(callback: (data: T[]) => void): () => void {
      ...
      ).createSubscription(collectionName, collection, callback);
    },
  };
}
...
export class MockAdapter implements IDataAdapter {
  ...
  constructor() {
    ...
    this.tasks = d.tasks;
    this.labNotebookEntries = d.labNotebookEntries;
    this.maintenanceLogs = d.maintenanceLogs;
    this.announcements = d.announcements;
    this.certificates = d.certificates;
    this.sds = d.sds;
    this.monthlyReports = [];
    this.tickets = [];
    this.regulatoryRequirements = d.regulatoryRequirements;
    this.insuranceCertificates = d.insuranceCertificates;
    this.chatRooms = d.chatRooms;
    this.chatMessages = d.chatMessages;
    ...
    this.consumableCrud = createGenericCrud(
      this.consumables,
      'consumables',
      this
    );
    ...
    this.labNotebookCrud = createGenericCrud(
      this.labNotebookEntries,
      'labNotebookEntries',
      this
    );
    this.maintenanceLogCrud = createGenericCrud(
      this.maintenanceLogs,
      'maintenanceLogs',
      this
    );
    this.announcementCrud = createGenericCrud(
      this.announcements,
      'announcements',
      this
    );
    this.certificateCrud = createGenericCrud(
      this.certificates,
      'certificates',
      this
    );
    this.sdsCrud = createGenericCrud(this.sds, 'sds', this);
    this.monthlyReportCrud = createGenericCrud(
      this.monthlyReports,
      'monthlyReports',
      this
    );
    this.ticketCrud = createGenericCrud(this.tickets, 'tickets', this);
    this.regulatoryRequirementCrud = createGenericCrud(
      this.regulatoryRequirements,
      'regulatoryRequirements',
      this
    );
    this.insuranceCertificateCrud = createGenericCrud(
      this.insuranceCertificates,
      'insuranceCertificates',
      this
    );

    this.getCompanies = this.companyCrud.getAll;
    this.getCompanyById = this.companyCrud.getById;
    this.createCompany = this.companyCrud.create;
    this.updateCompany = this.companyCrud.update;
    this.deleteCompany = this.companyCrud.delete;
    this.subscribeToCompanies = this.companyCrud.subscribe;
    this.getEquipmentList = this.equipmentCrud.getAll;
    this.getEquipmentById = this.equipmentCrud.getById;
    this.createEquipment = this.equipmentCrud.create;
    this.updateEquipment = this.equipmentCrud.update;
    this.deleteEquipment = this.equipmentCrud.delete;
    this.subscribeToEquipment = this.equipmentCrud.subscribe;
    this.getUsages = this.usageCrud.getAll;
    this.getUsageById = this.usageCrud.getById;
    this.createUsage = this.usageCrud.create;
    this.updateUsage = this.usageCrud.update;
    this.deleteUsage = this.usageCrud.delete;
    this.subscribeToUsages = this.usageCrud.subscribe;
    this.getConsumables = this.consumableCrud.getAll;
    this.getConsumableById = this.consumableCrud.getById;
    this.createConsumable = this.consumableCrud.create;
    this.updateConsumable = this.consumableCrud.update;
    this.deleteConsumable = this.consumableCrud.delete;
    this.subscribeToConsumables = this.consumableCrud.subscribe;
    this.getOrders = this.orderCrud.getAll;
    this.getOrderById = this.orderCrud.getById;
    this.updateOrder = this.orderCrud.update;
    this.deleteOrder = this.orderCrud.delete;
    this.subscribeToOrders = this.orderCrud.subscribe;
    this.getProjects = this.projectCrud.getAll;
    this.getProjectById = this.projectCrud.getById;
    this.createProject = this.projectCrud.create;
    this.updateProject = this.projectCrud.update;
    this.deleteProject = this.projectCrud.delete;
    this.subscribeToProjects = this.projectCrud.subscribe;
    this.getLabNotebookEntries = this.labNotebookCrud.getAll;
    this.createLabNotebookEntry = this.labNotebookCrud.create;
    this.updateLabNotebookEntry = this.labNotebookCrud.update;
    this.deleteLabNotebookEntry = this.labNotebookCrud.delete;
    this.subscribeToLabNotebookEntries = this.labNotebookCrud.subscribe;
    this.getMaintenanceLogs = this.maintenanceLogCrud.getAll;
    this.getMaintenanceLogById = this.maintenanceLogCrud.getById;
    this.createMaintenanceLog = this.maintenanceLogCrud.create;
    this.updateMaintenanceLog = this.maintenanceLogCrud.update;
    this.deleteMaintenanceLog = this.maintenanceLogCrud.delete;
    this.subscribeToMaintenanceLogs = this.maintenanceLogCrud.subscribe;
    this.getAnnouncements = this.announcementCrud.getAll;
    this.getAnnouncementById = this.announcementCrud.getById;
    this.createAnnouncement = this.announcementCrud.create;
    this.updateAnnouncement = this.announcementCrud.update;
    this.deleteAnnouncement = this.announcementCrud.delete;
    this.subscribeToAnnouncements = this.announcementCrud.subscribe;
    this.getCertificates = this.certificateCrud.getAll;
    this.getCertificateById = this.certificateCrud.getById;
    this.createCertificate = this.certificateCrud.create;
    this.updateCertificate = this.certificateCrud.update;
    this.deleteCertificate = this.certificateCrud.delete;
    this.subscribeToCertificates = this.certificateCrud.subscribe;
    this.getSds = this.sdsCrud.getAll;
    this.getSdsById = this.sdsCrud.getById;
    this.createSds = this.sdsCrud.create;
    this.updateSds = this.sdsCrud.update;
    this.deleteSds = this.sdsCrud.delete;
    this.subscribeToSds = this.sdsCrud.subscribe;
    this.getMonthlyReports = this.monthlyReportCrud.getAll;
    this.createMonthlyReport = this.monthlyReportCrud.create;
    this.subscribeToMonthlyReports = this.monthlyReportCrud.subscribe;
    this.getTickets = this.ticketCrud.getAll;
    this.getTicketById = this.ticketCrud.getById;
    this.createTicket = this.ticketCrud.create;
    this.updateTicket = this.ticketCrud.update;
    this.deleteTicket = this.ticketCrud.delete;
    this.subscribeToTickets = this.ticketCrud.subscribe;
    this.getRegulatoryRequirements = this.regulatoryRequirementCrud.getAll;
    this.getRegulatoryRequirementById = this.regulatoryRequirementCrud.getById;
    this.createRegulatoryRequirement = this.regulatoryRequirementCrud.create;
    this.updateRegulatoryRequirement = this.regulatoryRequirementCrud.update;
    this.deleteRegulatoryRequirement = this.regulatoryRequirementCrud.delete;
    this.subscribeToRegulatoryRequirements =
      this.regulatoryRequirementCrud.subscribe;
    this.getInsuranceCertificates = this.insuranceCertificateCrud.getAll;
    this.getInsuranceCertificateById = this.insuranceCertificateCrud.getById;
    this.createInsuranceCertificate = this.insuranceCertificateCrud.create;
    this.updateInsuranceCertificate = this.insuranceCertificateCrud.update;
    this.deleteInsuranceCertificate = this.insuranceCertificateCrud.delete;
    this.subscribeToInsuranceCertificates =
  ...
  public createSubscription<T>(
    ...
    callback(dataArray);
    return () => {
      const updatedCbs = (this.subscribers.get(collectionName) || []).filter(
  ...
  async getUserById(id: string): Promise<Result<User | null>> {
    return { success: true, data: this.users.find((u) => u.id === id) || null };
  }
  ...
  async getReservationById(id: string): Promise<Result<Reservation | null>> {
    return {
      success: true,
      data: this.reservations.find((r) => r.id === id) || null,
    };
  }
  ...
  async updateReservation(
    ...
    if (i === -1)
      return { success: false, error: new Error('Reservation not found') };
  ...
  subscribeToTasks(callback: (data: Task[]) => void): () => void {
    return this.createSubscription('tasks', this.tasks, callback);
  }
  ...
  async getChatRooms(userId: string): Promise<Result<ChatRoom[]>> {
    return {
      success: true,
      data: this.chatRooms.filter((r) => r.participantIds.includes(userId)),
    };
  }
  subscribeToChatRooms(
    userId: string,
    callback: (data: ChatRoom[]) => void
  ): () => void {
    return this.createSubscription('chatRooms', this.chatRooms, (allRooms) => {
      const userRooms = (allRooms as ChatRoom[])
  ...
  subscribeToChatMessages(
    ...
    return this.createSubscription(
      ...
      this.chatMessages,
      (allMessages) => {
        const roomMessages = (allMessages as ChatMessage[])
          .filter((m) => m.roomId === roomId)
          .sort(
            (a, b) =>
              new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()
  ...
  async sendChatMessage(
    data: Omit<ChatMessage, 'id' | 'readBy'>
