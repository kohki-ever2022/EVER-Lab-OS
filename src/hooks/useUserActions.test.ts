...
const mockFacilityDirector: User = {
  id: 'admin-user',
  name: 'Admin',
  email: 'admin@test.com',
  companyId: 'company-lab',
...
describe('useUserActions', () => {
  ...
  it('should add a user successfully with admin privileges', async () => {
    ...
    (mockAdapter.createUser as any).mockResolvedValue({
      success: true,
      data: createdUser,
    });
    ...
    const wrapper = createWrapper({
      adapter: mockAdapter,
      sessionContextValue: adminSessionContext,
    });
  ...
  it('should fail to add a user if lacking permissions', async () => {
    ...
    const wrapper = createWrapper({
      adapter: mockAdapter,
      sessionContextValue: researcherSessionContext,
    });
    const { result } = renderHook(() => useUserActions(), { wrapper });
  ...
  it('should update a user successfully', async () => {
    ...
    (mockAdapter.updateUser as any).mockResolvedValue({
      success: true,
      data: userToUpdate,
    });
  ...
  it('should delete a user successfully', async () => {
    ...
    (mockAdapter.deleteUser as any).mockResolvedValue({
      success: true,
      data: undefined,
    });
