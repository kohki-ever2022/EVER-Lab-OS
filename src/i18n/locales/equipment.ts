...
export const equipment = {
  ...
  noEquipmentToDisplay: {
    ja: '表示する機器はありません。',
    en: 'No equipment to display.',
  },
  equipmentList: { ja: '機器一覧', en: 'Equipment List' },
  equipmentSaved: {
    ja: '機器情報を保存しました。',
    en: 'Equipment saved successfully.',
  },
  deleteEquipmentConfirm: {
    ja: 'この機器を削除しますか？関連する予約やログも影響を受ける可能性があります。',
    en: 'Are you sure you want to delete this equipment? Associated reservations and logs may be affected.',
  },
  equipmentDeleted: { ja: '機器を削除しました。', en: 'Equipment deleted.' },
  equipmentMasterManagement: {
    ja: '機器マスタ管理',
    en: 'Equipment Master Management',
  },
  ...
  noMaintenanceLogs: {
    ja: 'メンテナンスログはありません。',
    en: 'No maintenance logs.',
  },
  maintenanceStatus: { ja: 'メンテナンス状況', en: 'Maintenance Status' },
  latestReport: { ja: '最新の報告', en: 'Latest Report' },
  noDetailedReport: {
    ja: '詳細な不具合報告はありません。',
    en: 'No detailed issue report available.',
  },
  noMaintenanceEquipment: {
    ja: '現在メンテナンス中の機器はありません。',
    en: 'No equipment is currently under maintenance.',
  },
  ...
  noReservationHistory: {
    ja: '予約履歴はありません。',
    en: 'No reservation history.',
  },
  waitlist: { ja: '待機リスト', en: 'Waitlist' },
  noWaitlists: {
    ja: '待機中の予約はありません。',
    en: 'You are not on any waitlists.',
  },
  ...
  slotUnavailable: {
    ja: '予約枠が利用できません',
    en: 'Booking Slot Unavailable',
  },
  slotUnavailableMsg: {
    ja: '選択した時間帯は既に予約されています。別の時間を選択するか、待機リストに追加してください。',
    en: 'The selected time slot is already booked. Please choose another time or add yourself to the waitlist.',
  },
  ...
  issueReported: {
    ja: '問題を報告しました。管理者が確認します。',
    en: 'Issue reported. An administrator will review it.',
  },
  ...
  noReservationsNext7Days: {
    ja: '今後7日間に予約はありません。',
    en: 'No reservations in the next 7 days.',
  },
  notificationEquipmentMaintenance: {
    ja: '{name}がメンテナンス中に設定されました。',
    en: '{name} has been set to maintenance.',
  },
  notificationEquipmentMalfunctionTitle: {
    ja: '機器の不具合',
    en: 'Equipment Malfunction',
  },
  notificationEmergencyStopTitle: {
    ja: '緊急停止通知',
    en: 'Emergency Stop Notification',
  },
  notificationEmergencyStop: {
    ja: '全機器が緊急停止されました。',
    en: 'All equipment has been stopped due to an emergency.',
  },
  rate: { ja: '料金', en: 'Rate' },
