...
const createCoreInfraData = () => {
  ...
  const companies: Company[] = [
    ...
    },
    {
      ...
      billingEmail: 'billing@tenant-a.com',
      registrationNumber: 'T1112223334445',
      isActive: true,
      mfPartnerId: 'mf-partner-a',
    },
    {
      id: 'company-b',
      nameJP: '株式会社BioFuture',
      nameEN: 'BioFuture Ltd.',
      planId: 'plan-standard',
      consolidatedBilling: true,
      contractType: ContractType.Monthly,
      contractStartDate: new Date('2023-08-01'),
      billingEmail: 'accounts@biofuture.com',
      registrationNumber: 'T5556667778889',
      isActive: true,
      mfPartnerId: 'mf-partner-b',
    },
    {
      id: 'company-c',
      nameJP: 'Pharma Solutions',
      nameEN: 'Pharma Solutions',
      planId: 'plan-standard',
      consolidatedBilling: false,
      contractType: ContractType.Monthly,
      contractStartDate: new Date('2023-09-01'),
      billingEmail: 'finance@pharma.com',
      registrationNumber: 'T9998887776665',
      isActive: false,
      mfPartnerId: 'mf-partner-c',
    },
    {
      id: 'company-s',
      nameJP: 'サプライヤー株式会社',
  ...
  const equipment: Equipment[] = [
    {
      ...
      granularity: '',
      imageUrl:
        'https://images.unsplash.com/photo-1628744448592-a185123c5333?q=80&w=800',
      isReservable: false,
    },
    {
      id: 'eq-incubator-02',
      ...
      granularity: '',
      imageUrl:
        'https://images.unsplash.com/photo-1635051910633-65e378255933?q=80&w=800',
      isReservable: false,
    },
    {
      id: 'some-other-incubator-id',
      nameJP: 'CO2インキュベーター #2',
      nameEN: 'CO2 Incubator #2',
      categoryJP: '培養',
      categoryEN: 'Culture',
      status: EquipmentStatus.InUse,
      rate: 0,
    ...
    {
      id: 'yet-another-incubator-id',
      nameJP: 'CO2インキュベーター #3',
      nameEN: 'CO2 Incubator #3',
      categoryJP: '培養',
      categoryEN: 'Culture',
    ...
    },
    {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1628744448592-a185123c5333?q=80&w=800',
      isReservable: true,
      requiredQualificationId: 'qual-bsl2',
      manualIds: ['manual-002'],
    },
  ];
  return { equipment };
};
  ...
  const qualifications: Qualification[] = [
    {
      id: 'qual-bsl2',
      nameJP: 'BSL-2 利用資格',
      nameEN: 'BSL-2 Certification',
    },
    {
      id: 'qual-autoclave',
      nameJP: 'オートクレーブ利用資格',
      nameEN: 'Autoclave Certification',
    },
  ];
  ...
  const userCertifications: UserCertification[] = [
    {
      ...
      qualificationId: 'qual-bsl2',
      issuedAt: new Date('2023-01-01'),
      expiresAt: new Date('2025-01-01'),
      courseId: 'course-bsl2',
    },
    {
      id: 'cert-2',
      userId: 'user-director',
      qualificationId: 'qual-autoclave',
      issuedAt: new Date('2023-01-01'),
      expiresAt: new Date('2025-01-01'),
      courseId: 'course-autoclave',
    },
    {
      id: 'cert-3',
      userId: 'user-pm-a',
  ...
  const users: User[] = [
    {
      id: 'user-director',
      name: 'Taro Suzuki',
      email: 'taro.suzuki@ever.com',
      companyId: 'company-lab',
      role: Role.FacilityDirector,
      roleCategory: RoleCategory.Facility,
      availabilityStatus: UserAvailabilityStatus.Available,
      qualificationIds: ['qual-bsl2', 'qual-autoclave'],
      favoriteEquipmentIds: [],
    },
    {
      id: 'user-lab-manager',
      name: 'Jiro Tanaka',
      email: 'jiro.tanaka@ever.com',
      companyId: 'company-lab',
      role: Role.LabManager,
      roleCategory: RoleCategory.Facility,
      availabilityStatus: UserAvailabilityStatus.Busy,
      statusMessage: 'Meeting until 3pm',
      qualificationIds: ['qual-bsl2', 'qual-autoclave'],
      favoriteEquipmentIds: ['eq-bsc-01'],
    },
    {
      id: 'user-pm-a',
      name: 'Hanako Yamada',
      email: 'hanako.yamada@tenant-a.com',
      companyId: 'company-a',
      role: Role.ProjectManager,
      roleCategory: RoleCategory.Tenant,
      qualificationIds: ['qual-bsl2'],
      favoriteEquipmentIds: ['eq-bsc-01', 'eq-incubator-02'],
    },
    {
      id: 'user-res-a',
      name: 'Ichiro Sato',
      email: 'ichiro.sato@tenant-a.com',
      companyId: 'company-a',
    ...
    },
    {
      id: 'user-res-b',
      name: 'Jane Smith',
      email: 'jane.smith@biofuture.com',
      companyId: 'company-b',
      role: Role.Researcher,
      roleCategory: RoleCategory.Tenant,
      favoriteEquipmentIds: [],
    },
    {
      ...
      companyId: 'company-s',
      role: Role.Supplier,
      roleCategory: RoleCategory.External,
      favoriteEquipmentIds: [],
    },
  ];
  ...
  const projects: Project[] = [
    {
      id: 'proj-a1',
      name: '細胞株開発プロジェクト',
      description: '新しい抗体医薬のための細胞株を開発する。',
      companyId: 'company-a',
      memberIds: ['user-pm-a', 'user-res-a'],
      milestones: [
        {
          id: 'm1',
          name: 'Phase 1',
    ...
    },
    {
      ...
      description: 'CRISPR-Cas9 technology for new therapeutic approaches.',
      companyId: 'company-b',
      memberIds: ['user-pm-b', 'user-res-b'],
      milestones: [
        {
          id: 'm4',
          name: 'Pre-clinical',
  ...
  const tasks: Task[] = [
    {
      ...
      assigneeIds: ['user-res-a'],
      startDate: new Date('2024-07-01'),
      dueDate: new Date('2024-07-05'),
      isPrivate: false,
      createdByUserId: 'user-pm-a',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
    ...
    {
      id: 't4',
      title: 'Design gRNA sequences',
      projectId: 'proj-b1',
      status: TaskStatus.Done,
      priority: TaskPriority.High,
      scope: TaskScope.Team,
      assigneeIds: ['user-res-b'],
      startDate: new Date('2024-07-10'),
      dueDate: new Date('2024-07-18'),
      isPrivate: false,
      createdByUserId: 'user-pm-b',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      id: 't5',
      title: 'Transfection experiment',
      projectId: 'proj-b1',
      status: TaskStatus.InProgress,
      priority: TaskPriority.High,
      scope: TaskScope.Team,
    ...
    },
    {
      ...
      priority: TaskPriority.Medium,
      scope: TaskScope.Team,
      assigneeIds: ['user-pm-b', 'user-res-b'],
  ...
  const chatMessages: ChatMessage[] = [
    {
      ...
      senderId: 'user-pm-a',
      content:
        'お世話になっております。先日申請したBSL-2エリアの利用許可について、進捗はいかがでしょうか？',
    ...
    },
    {
      ...
      content:
        'ご連絡ありがとうございます。承知いたしました。申請内容を確認いたします。',
...
const createOperationData = () => {
  const co2IncubatorTrackingData: CO2IncubatorTracking[] = [
    ...
    {
      id: 'co2-track-2',
      equipmentId: 'some-other-incubator-id',
...
export function getMockData() {
  ...
  return {
    ...
    announcements: [],
    systemSettings: {
      labOpeningTime: '09:00',
      labClosingTime: '21:00',
      noShowPenalty: 1000,
      surgePricingEnabled: false,
      surgeMultiplier: 1.5,
      surgeStartTime: '18:00',
      surgeEndTime: '21:00',
    },
    taxRates: [],
    maintenanceLogs: [],
