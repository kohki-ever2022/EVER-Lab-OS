...
export const QmsProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
  ...
  const [ehsIncidents, setEhsIncidents] = useState<EhsIncident[]>(
    initialData.ehsIncidents
  );
  ...
  const [userCertifications, setUserCertifications] = useState<
    UserCertification[]
  >(initialData.userCertifications);
