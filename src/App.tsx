...
const FavoriteConsumablesList = lazy(
  () => import('./components/inventory/FavoriteConsumablesList')
);
const ElectronicLabNotebook = lazy(
  () => import('./components/project/ElectronicLabNotebook')
);
const ProjectProgressDashboard = lazy(
  () => import('./components/project/ProjectProgressDashboard')
);
const SupplierDashboard = lazy(
  () => import('./components/supplier/SupplierDashboard')
);
const ReorderSuggestions = lazy(
  () => import('./components/inventory/ReorderSuggestions')
);
const CertificateManagement = lazy(
  () => import('./components/certificates/CertificateManagement')
);
const Settings = lazy(() => import('./components/admin/Settings'));
const AdminDashboard = lazy(() => import('./components/admin/AdminDashboard'));
const EquipmentManagement = lazy(
  () => import('./components/admin/EquipmentManagement')
);
const UserManagement = lazy(() => import('./components/admin/UserManagement'));
const AuditLog = lazy(() => import('./components/admin/AuditLog'));
const MaintenanceLogViewer = lazy(
  () => import('./components/equipment/MaintenanceLogViewer')
);
const MaintenanceStatus = lazy(
  () => import('./components/equipment/MaintenanceStatus')
);
const MemberManagement = lazy(
  () => import('./components/user/MemberManagement')
);
const ManualManagement = lazy(
  () => import('./components/qms/ManualManagement')
);
const LabRuleManagement = lazy(
  () => import('./components/qms/LabRuleManagement')
);
const FacilityConsumableNotification = lazy(
  () => import('./components/facility/FacilityConsumableNotification')
);
const InventoryLockManager = lazy(
  () => import('./components/admin/InventoryLockManager')
);
const MonthlyReportGenerator = lazy(
  () => import('./components/admin/MonthlyReportGenerator')
);
const HazardousMaterialsDashboard = lazy(
  () => import('./components/inventory/HazardousMaterialsDashboard')
);
const RegulatoryCompliance = lazy(
  () => import('./components/compliance/RegulatoryCompliance')
);
const FacilityLayout = lazy(
  () => import('./components/facility/FacilityLayout')
);
const InsuranceManagement = lazy(
  () => import('./components/compliance/InsuranceManagement')
);
const CO2IncubatorManagement = lazy(
  () => import('./components/equipment/CO2IncubatorManagement')
);
const ProjectGanttChart = lazy(
  () => import('./components/project/ProjectGanttChart')
);
    ...
    <>
      <Routes>
        <Route path='/' element={<AppLayout />}>
          ...
          <Route
            path='facilityConsumableNotification'
            element={<FacilityConsumableNotification />}
          />
          ...
          <Route
            path='favoriteConsumables'
            element={<FavoriteConsumablesList />}
          />
          <Route
            path='electronicLabNotebook'
            element={<ElectronicLabNotebook />}
          />
          <Route
          ...
          <Route
            path='hazardousMaterialsDashboard'
            element={<HazardousMaterialsDashboard />}
          />
          <Route path='compliance' element={<RegulatoryCompliance />} />
          <Route path='facilityLayout' element={<FacilityLayout />} />
          <Route
            path='inventoryLockManager'
            element={<InventoryLockManager />}
          />
          <Route
            path='co2IncubatorManagement'
            element={<CO2IncubatorManagement />}
          />
          <Route
            path='monthlyReportGenerator'
            element={<MonthlyReportGenerator />}
          />
